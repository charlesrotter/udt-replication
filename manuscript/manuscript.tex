...
This inverts the na\"ive objection ``UDT is $3\times$ worse than
$\Lambda$CDM on TT'' into evidence that $\Lambda$CDM may be
contaminating its own validation data.  The decisive test will come
from CMB-S4 and Simons Observatory, which will provide the cleanest
ground-based measurements to date.
