...
(Sec.~\ref{sec:metric}), then validate the cosmological distance
relation against Type~Ia supernovae
(Sec.~\ref{sec:sne}).  Sections~\ref{sec:causality}
and~\ref{sec:gr-reduction} establish causality and reduction to
standard GR at accessible scales.  Section~\ref{sec:bao} extends the
...
the metric.  Sections~\ref{sec:alpha}--\ref{sec:pmns} derive coupling
constants, neutrino parameters, and mixing angles.
Sections~\ref{sec:bridge-gen}--\ref{sec:cmb} establish the bridge between
microphysical and cosmological sectors.
Sections~\ref{sec:jwst}--\ref{sec:blackholes} discuss astrophysical
implications.  Section~\ref{sec:falsify} presents the full predictions
table and falsification criteria.
Sections~\ref{sec:discussion}--\ref{sec:conclusion} discuss and
conclude.
