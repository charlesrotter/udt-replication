...
The third row involves $\rho$ and $\eta$ (equivalently
$\bar{\rho}$ and $\bar{\eta}$).  The CP phase
$\delta = \arctan(9/4)$ determines $\eta$ through
$\eta = A\lambda^2\sin\delta/(1-\lambda^2/2)$.
