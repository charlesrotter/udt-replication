...
$(2l+1)^2/((2j+1)^3(2|\kappa_\mathrm{max}|-1))$ & 9/40 & Cabibbo angle $\sin\theta_C$ \\
$(2l+1)/((2j+1)^2+(2l+1)^2)$ & 3/13 & Weinberg angle $\sin^2\theta_W$ \\
$(2l+1)^2/(2j+1)^2$ & 9/4 & $\alpha_s/\alpha_\mathrm{EM}$ ratio \\
$(2j+1)^3(2l+1)^2(2|\kappa_\mathrm{max}|+1)$ & 504 & Higgs VEV coefficient \\
$(2j+1)^3(2l+1)$ & 24 & Higgs $\lambda$ denominator \\
$(2l+1)(2|\kappa_\mathrm{max}|-1)$ & 15 & $g_{\pi NN}$ denominator \\
$[(2l+1)(2|\kappa_\mathrm{max}|-1)]^2$ & 225 & $g^2/(4\pi)$ denominator \\
$\binom{9}{2} \times (2|\kappa_\mathrm{max}|-1)$ & 180 & $f_\pi$ coefficient \\
\bottomrule
\end{tabular}
\end{center}
