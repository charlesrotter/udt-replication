...
or $\pi$), giving $J_\mathrm{CP} = 0$. This is a testable prediction: if
$\delta_\mathrm{CP}$ is measured to be significantly different from $0$ or
$\pi$, it would falsify this aspect of UDT.
